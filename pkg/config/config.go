...
import (
	...
	"github.com/boilingsitar/mss-boot/pkg/config/source/appconfig"
	"github.com/boilingsitar/mss-boot/pkg/config/source/configmap"
	sourceConsul "github.com/boilingsitar/mss-boot/pkg/config/source/consul"
	sourceFS "github.com/boilingsitar/mss-boot/pkg/config/source/fs"
	"github.com/boilingsitar/mss-boot/pkg/config/source/gorm"
	sourceLocal "github.com/boilingsitar/mss-boot/pkg/config/source/local"
	"github.com/boilingsitar/mss-boot/pkg/config/source/mgdb"
	sourceS3 "github.com/boilingsitar/mss-boot/pkg/config/source/s3"
)
